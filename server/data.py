# data.py
"""
Game data module containing word categories for the Imposter game.

This module defines various categories of words that can be used in the game.
Each category contains a list of words that players will try to describe.
"""
